												...
												<fieldset>
													...
													<label class="block clearfix">
														...
														<span class="block input-icon input-icon-right">
															<input type="text" style=" <?php if(@$err){ ?> border-color:#FF0000; background-color:rgba(215, 17, 13, 0.16);<?php } ?>" name="email" autocomplete="off" class="form-control" placeholder="User Email" />
															<i class="ace-icon fa 
																<?php if(@$err)
																		{
													...
													<label class="block clearfix">
														...
														<span class="block input-icon input-icon-right">
															...
															<i toggle="#password-field" class="fa fa-eye field-icon toggle-password" style=''></i>
														</span>
													</label>
